...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideCharacterRemoteDataSource(characterService: CharacterApi) = CharacterDataSource(characterService)
    ...
    @Singleton
    @Provides
    fun provideRepository(remoteDataSource: CharacterDataSource,
